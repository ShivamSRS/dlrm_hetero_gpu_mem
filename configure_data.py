...
def make_loaders(args):
    ...
    train = torch.randint(1025, (10000, 1024,1024))#ranodm tensor with numelems 10000, seq len 512, vocab len 1024
    valid = torch.randint(1025, (100, 1024,1024))
    test = torch.randint(1025, (1000, 1024,1024))

    train = make_data_loader(train, batch_size, args)
    valid = make_data_loader(valid, batch_size, args)
    test = make_data_loader(test, batch_size, args)
